...
// Add to web1/public/js/main.js and web2/public/js/main.js
...
function sendMessage() {
    ...
    if (message) {
        socket.emit("chat-message", { 
            ...
            to: targetUsername, 
            message,
            room: 'web2' // or 'web1' depending on client
        });
        ...
        if (file.size <= 900 * 1024) { // 900KB limit
            ...
            reader.onload = function(e) {
                ...
                socket.emit("file-message", { 
                    ...
                    fileName: file.name, 
                    fileType: file.type,
                    room: 'web2' // or 'web1' depending on the client
                });
